...
**Computer Systems Engineer and Programming Technician** with over 3 years of experience in **Full Stack software development** and a strong pivot into **Offensive Cybersecurity (Red Team)**. My methodology bridges the gap between development and security: I build robust MVC applications and RESTful APIs, and then I apply ethical hacking tactics to secure them from the design phase.

Currently training for **eJPTv2**, **CompTIA Security+**, and **AWS Certified Cloud Practitioner**.
