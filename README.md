...
* **🛡️ Security Analytics & Blue Team Operations:** My primary focus. Operations in SIEM (**Splunk**), Threat Modeling (**MITRE ATT&CK**), Detection Engineering (**Sigma Rules, YARA**), Incident Management (**SecurityOnion**), and Digital Forensics on **Windows** systems.
...
* **🌐 Full Stack Software Engineering & AI:** Architecture, development, and deployment of solutions adapted to complex business logic. Integration of **AI & Deep Learning** (CNNs, LangChain). Management of the Software Development Life Cycle (SDLC) under agile methodologies using Python, PHP, JavaScript, TypeScript, and frameworks like Angular, React, Tailwind CSS, and Bootstrap.
