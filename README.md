...
* **🛡️ Security Analytics:** My primary focus. Operations in SIEM (**Splunk**), Threat Modeling (**MITRE ATT&CK**), Detection Engineering (**Sigma Rules, YARA**), Incident Management (**SecurityOnion**), and Digital Forensics on **Windows** systems.
