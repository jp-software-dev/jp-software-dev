...
* **🛡️ Security Analytics & Blue Team Operations:** My primary focus. Operations in SIEM (**Microsoft Sentinel**, **Splunk**), Threat Modeling (**MITRE ATT&CK**), Detection Engineering (**Sigma Rules, YARA**), Incident Management (**SecurityOnion**), and Digital Forensics on **Windows** systems.
* **🥷 Offensive Security (Red Team Knowledge):** Web and network pentesting, vulnerability analysis and exploitation (OWASP Top 10), post-exploitation (Metasploit, Burp Suite, Nmap), and development of offensive scripts with **Python** (Scapy) to better understand and build defensive mechanisms.
